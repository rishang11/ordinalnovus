...
// Utility function to convert Decimal128 to number
const decimal128ToNumber = (value: mongoose.Types.Decimal128): number => {
  const buffer = value["$numberDecimal"].toString();
...
export const formatSmallNumber = (
  ...
  if (price && typeof price != "number") {
    price = decimal128ToNumber(price);
  }
